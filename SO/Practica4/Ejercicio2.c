/*
Ejercicio 2 - Práctica 4 - Sistemas Operativos
Implementar un programa en lenguaje C, que simule al algoritmo SJF (Shortest Job First).
*/
...
int main(int argc, char const *argv[]) {
  int i, j; //Iteradores.
  parametros aux; //Variable auxiliar para oridenación.
  ...
  for(i = 0; i < PROCESOS; i++){  //Cálculo de los tiempos de finalización, retorno y espera.
  ...
  for(i = 1 ; i < PROCESOS; i++){  //Salida en orden de los procesos en SJF (Tabla 2): A-E-B-D-C.
    for(j = i + 1; j < PROCESOS; j++){
